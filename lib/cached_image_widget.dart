...
/// the image failed loading, for example due to a file not found exception.
...
class CachedNetworkImage extends StatelessWidget {
  ...
  /// Evict an image from the in memory [ImageCache] of the [ImageProvider].
  /// [url] is used by the memory cache. The scale is only used
  ...
  /// The target local image path that is displayed.
