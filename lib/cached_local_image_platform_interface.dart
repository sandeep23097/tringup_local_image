/// Platform interface for CachedLocalImage
library tringup_local_image_platform_interface;
...
/// ImageLoader class to load local images differently on various platforms.
class ImageLoader {
  /// loads the local images async and gives the resulted codecs on a Stream. The
  /// Stream gives the option to show multiple images after each other.
  @Deprecated('Use loadImageAsync instead')
  Stream<ui.Codec> loadBufferAsync(
      String url, // Now represents local file path
      String? cacheKey,
      StreamController<ImageChunkEvent> chunkEvents,
      DecoderBufferCallback decode,
      BaseCacheManager cacheManager, // Not used for local images but kept for compatibility
      int? maxHeight,
      int? maxWidth,
      Map<String, String>? headers, // Not used for local images but kept for compatibility
