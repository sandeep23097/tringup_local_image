...
import 'package:tringup_local_image/image_provider/multi_image_stream_completer.dart';
...
class CachedNetworkImageProvider
  ...
  /// Local file path of the image to load
  final String url;
  ...
  /// Set headers for the image provider
  /// Note: For local images, this is not used but kept for compatibility
  final Map<String, String>? headers;

  /// Maximum height of the loaded image. If not null the image is resized to fit the height.
  final int? maxHeight;

  /// Maximum width of the loaded image. If not null the image is resized to fit the width.
  final int? maxWidth;
